...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_Application_Locale: EntityBase, IAuditable, ILocale
    {
        [Key]
        public int ApplicationLocaleRef { get; set; }
        ...
        public override int ObjectRef => this.ApplicationLocaleRef;
    }
}
