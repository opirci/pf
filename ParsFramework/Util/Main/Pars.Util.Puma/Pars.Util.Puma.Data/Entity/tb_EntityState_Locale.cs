...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_EntityState_Locale:EntityBase, ILocale, IAuditable
    {
        [Key]
        public int EntityStateLocaleRef { get; set; }
        ...
        public override int ObjectRef => this.EntityStateLocaleRef;
    }
}
