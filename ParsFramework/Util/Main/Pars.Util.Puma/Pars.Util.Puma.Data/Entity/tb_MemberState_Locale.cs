...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_MemberState_Locale : EntityBase, IAuditable, ILocale
    {
        [Key]
        public int MemberStateLocaleRef { get; set; }
        ...
        public override int ObjectRef => this.MemberStateLocaleRef;
    }
}
