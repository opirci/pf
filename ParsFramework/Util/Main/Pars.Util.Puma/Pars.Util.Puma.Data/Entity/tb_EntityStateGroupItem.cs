...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_EntityStateGroupItem:EntityBase, IAuditable
    {
        [Key]
        public int EntityStateGroupItemRef { get; set; }
        ...
        public override int ObjectRef => this.EntityStateGroupItemRef;
    }
}
