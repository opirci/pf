...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_UserGroupItem: EntityBase, IAuditable
    {
        [Key]
        public int UserGroupItemRef { get; set; }
        ...
        public short? SynchSourceRef { get; set; }
        ...
        public override int ObjectRef => this.UserGroupItemRef;
    }
}
