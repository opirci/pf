...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_MenuType_Locale:EntityBase, IAuditable, ILocale
    {
        [Key]
        public int MenuTypeLocaleRef { get; set; }
        ...
        public override int ObjectRef => this.MenuTypeLocaleRef;
    }
}
