...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_UserEnvironment: EntityBase, IAuditable
    {
        [Key]
        public int UserEnvironmentRef { get; set; }
        ...
        public override int ObjectRef => this.UserEnvironmentRef;
    }
}
