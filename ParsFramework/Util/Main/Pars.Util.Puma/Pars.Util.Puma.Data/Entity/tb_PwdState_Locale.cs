...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_PwdState_Locale: EntityBase, IAuditable, ILocale
    {
        [Key]
        public int PwdStateLocaleRef { get; set; }
        ...
        public override int ObjectRef => this.PwdStateLocaleRef;
    }
}
