...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_ApplicationMenu:EntityBase, IAuditable
    {
        [Key]
        public int ApplicationMenuRef { get; set; }
        ...
        public override int ObjectRef => this.ApplicationMenuRef;
    }
}
