...
namespace Pars.Util.Puma.Data
{
    ...
    public partial class tb_UserGroup_Locale: EntityBase, IAuditable, ILocale
    {
        [Key]
        public int UserGroupLocaleRef { get; set; }
        ...
        public override int ObjectRef => this.UserGroupLocaleRef;
    }
}
