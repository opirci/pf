...
namespace Pars.Util.Puma.Api.AuthManagement.App_Start
{
    public class SecurityConfig
    {
        public static void ConfigureGlobal(HttpConfiguration globalConfig)
        {
            globalConfig.MessageHandlers.Add(new Thinktecture.IdentityModel.Tokens.Http.AuthenticationHandler(CreateConfiguration()));
